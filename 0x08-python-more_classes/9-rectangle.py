...
class Rectangle():
    ...
    def __str__(self):
        ...
        if self.__height != 0 and self.__width != 0:
            for i in range(self.__height):
                string += "".join(str(self.print_symbol) for j in
                                  range(self.__width))
                string += "".join("\n")
        return string[:-1]
    ...
    def bigger_or_equal(rect_1, rect_2):
        """This static method returns the biggest rectangle based on the area

        Args:
            rect_1 (Rectangle instance): Rectangle 1
            rect_2 (Rectangle instance): Rectangle 2

        Raises:
            TypeError: if rect_1 is not a instance of Rectangle class
            TypeError: if rect_2 is not a instance of Rectangle class

        Returns:
            Rectangle instance: the biggest rectangle
        """
    ...
    def square(cls, size=0):
        """This class method defines a new instance of the class Rectangle

        Args:
            size (int, optional): width and height of the new rectangle.
            Defaults to 0.

        Returns:
            Rectangle instance: new rectangle equal to a square of size * size
        """
